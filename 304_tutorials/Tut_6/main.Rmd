...
question("For `Pacific_proportion`, you get an `exp(Est.)` value of 11.56. What does this tell us?",
  answer("There is, on average, 11.56 more acute rheumatic fever for a 1-unit increase in Pacific proportion", message = "No. 11.56 is a rate ratio. What word do we need to add to imply a ratio?"),
