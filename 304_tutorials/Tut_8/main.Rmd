...
![Marijuana joint](./images/marijuana_joint.avif "Joint"){width="20%"}
...
unsplash.com](./images/matthew-brodeur-qcCPIhhdgTw-unsplash.jpg "marijuana"){width="400"}
...
Today, we have extended regression to account for binary variables which
are often used in epidemiology. Logistic regression is used to predict
the probability of a binary outcome such as disease.

-   It is often used when the outcome is a binary variable and there are
